...
export default function App() {
  ...
  return (
    <>
      ...
      {/* =========================================================
          SPACEVERSE — CINEMATIC EARTH + MILKY WAY BACKGROUND
          ========================================================= */}
      {isDarkMode && (
        <div
          ...
          aria-hidden="true"
        >
          {/* User-provided cinematic background image */}
          <div
          ...
          <div
            className="absolute inset-[-2%] opacity-[0.12]"
            style={{
              background:
                'radial-gradient(circle at 14% 24%, rgba(255,255,255,.65) 0 1px, transparent 1.5px), radial-gradient(circle at 82% 18%, rgba(125,211,252,.55) 0 .8px, transparent 1.4px), radial-gradient(circle at 64% 76%, rgba(167,139,250,.45) 0 .8px, transparent 1.4px)',
              backgroundSize: '240px 240px, 190px 190px, 280px 280px',
              animation: 'spaceverseBgDust 34s linear infinite',
            }}
          />

          <style>{`
            @keyframes spaceverseBgDust {
      ...
      <div className="flex-1 flex flex-col min-w-0 h-screen overflow-y-auto pt-16 lg:pt-0 relative z-10">
        ...
        {/* DESKTOP TOP BAR — REFERENCE STYLE */}
        <header className={`sticky top-0 z-30 h-16 px-4 sm:px-6 lg:px-8 flex items-center justify-between gap-4 transition-colors duration-300 ${
          isDarkMode
            ? 'bg-[#02040a]/58 border-white/[0.06]'
          ...
          <div className="relative w-full max-w-md">
            ...
            <input
              ...
              className={`w-full h-9 pl-10 pr-4 rounded-full border text-xs outline-none transition-all ${
                isDarkMode
                  ? 'bg-[#020612]/48 border-white/10 text-white placeholder-slate-400 hover:border-cyan-400/20 focus:border-cyan-400/35 focus:ring-1 focus:ring-cyan-400/10'
                  : 'bg-white/72 border-slate-200 text-slate-900 placeholder-slate-500 hover:border-cyan-500/30 focus:border-cyan-500/50 focus:ring-1 focus:ring-cyan-500/10'
              }`}
            />
          </div>

          {/* Live Events + Notification + Astronaut Profile */}
          <div className="ml-auto flex items-center gap-2 sm:gap-3">
            ...
            <button
              ...
              className={`group hidden sm:flex items-center gap-2 rounded-full border px-3.5 py-2 text-[10px] font-semibold tracking-wide backdrop-blur-xl transition-all ${
                isDarkMode
                  ? 'border-emerald-400/20 bg-black/20 text-emerald-200 hover:border-emerald-300/40 hover:bg-emerald-400/[0.06]'
                  : 'border-emerald-500/25 bg-white/55 text-emerald-700 hover:border-emerald-500/45'
              }`}
            >
              <span className="relative flex h-2 w-2 items-center justify-center">
                <span className="absolute h-2.5 w-2.5 rounded-full bg-emerald-400/35 animate-ping" />
                <span className="relative h-1.5 w-1.5 rounded-full bg-emerald-400 shadow-[0_0_10px_rgba(52,211,153,.95)]" />
              </span>
            ...
            <button
              ...
              className={`relative flex h-9 w-9 items-center justify-center rounded-full border backdrop-blur-xl transition-all ${
                isDarkMode
                  ? 'border-white/10 bg-black/20 text-slate-300 hover:border-cyan-400/30 hover:bg-white/[0.05] hover:text-white'
                  : 'border-slate-200 bg-white/60 text-slate-600 hover:border-cyan-500/30 hover:text-slate-900'
              }`}
            >
              <Bell className="h-4 w-4" />
              <span className="absolute right-[6px] top-[5px] h-1.5 w-1.5 rounded-full bg-rose-400 shadow-[0_0_8px_rgba(251,113,133,.85)]" />
            </button>

            {/* Astronaut Profile */}
            <button
              type="button"
              aria-label="Astronaut profile"
              className={`group flex items-center gap-2 rounded-full border py-1 pl-1 pr-2.5 backdrop-blur-xl transition-all ${
                isDarkMode
            ...
            >
              ...
              <ChevronRight className="hidden md:block h-3.5 w-3.5 rotate-90 text-slate-400 transition-colors group-hover:text-cyan-300" />
            </button>
