...
<li>🚀 New space discoveries are made every year using advanced telescopes.</li>
  ...
  <div className="max-w-7xl mx-auto px-6 flex flex-col gap-4">
    ...
    <div className="flex flex-wrap items-center justify-center gap-4 sm:gap-6 text-[11px] uppercase tracking-widest">
      ...
      <a href="/terms.html" className="hover:text-cyan-400 transition-colors">
        Terms
      </a>
      <a href="/contact.html" className="hover:text-cyan-400 transition-colors">
        Contact
      </a>
      <a href="/disclaimer.html" className="hover:text-cyan-400 transition-colors">
        Disclaimer
      </a>
    </div>
  </div>
